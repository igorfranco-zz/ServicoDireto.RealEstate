...
appConfig.apiUrl = 'http://localhost:8082/api';
    ...
    {                   
        ...
        $scope.doLogin = function()
        {
            AccountService.Login( $scope.account )
                ...
                {
                    if($stateParams.redirectTo != undefined)     
