...
namespace SpongeSolutions.Core.Helpers.Serialization
{
    public class SerializationHelper
    {
        ...
        public static string SerializeJSON<T>(T source)
        {
            ...
            //    return sr.ReadToEnd();
            //}
            return JsonConvert.SerializeObject(source, Newtonsoft.Json.Formatting.None, new IsoDateTimeConverter() { DateTimeFormat = "yyyy-MM-dd hh:mm:ss" });
        }

        public static T DeSerializeJSON<T>(string source)
        {
            return JsonConvert.DeserializeObject<T>(source, new IsoDateTimeConverter() { DateTimeFormat = "yyyy-MM-dd hh:mm:ss" });
